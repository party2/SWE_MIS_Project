...
const Student = () => {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      const read = await Post('refresh')
      // console.log(read)
      setUserDetails(read?.data?.data?.user_details[0])
      setLoader(false)
    }
    fetchData()
  }, [])
                ...
                <Grid item xs={12} md={6} style={{ textAlign: 'center' }}>
                  ...
                  >
                    <Avatar
                      ...
                      src={
                        userDetails?.photopath ? process.env.ImageUrl + userDetails?.photopath : '/images/avatars/1.png'
                      }
                    />
                  </Badge>
                  <Divider />
                  <Grid item xs={12} md={6} style={{ textAlign: 'center' }}>
                    <Avatar
                      ...
                      alt={userDetails?.user_name}
                      src={
                        userDetails?.signpath ? process.env.ImageUrl + userDetails?.signpath : '/images/avatars/1.png'
                      }
                    />
                  </Grid>
                </Grid>
