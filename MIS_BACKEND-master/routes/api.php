...
Route::controller(BranchChange::class)->group(function () {
    ...
    Route::post('access_branch_checker', 'access_branch_checker');
    Route::get('get_course_branch', 'get_course_branch');
    Route::post('takebranchdata', 'getDataToSubmit');
    Route::post('getBranchChangeData', 'getBranchChangeData');
});
